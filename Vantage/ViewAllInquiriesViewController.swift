...
class ViewAllInquiriesViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, GADBannerViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "Cell", for: indexPath) as! ViewAllInquiriesTableViewCell
        
        if let inquiry = self.inquiries[indexPath.row] as? String {
            if inquiry == "none" {
                cell.textLabel!.text = "There are currently no active inquiries."
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if let inquiry = self.inquiries[indexPath.row] as? [String : AnyObject] {
            ...
            GlobalVariables._isViewingAllInquiries = true
            if let subject = inquiry["subject"] as? String {
                GlobalVariables._currentSubjectPostingTo = subject
            }
