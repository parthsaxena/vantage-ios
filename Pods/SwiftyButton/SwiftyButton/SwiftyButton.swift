...
public class SwiftyButton: UIButton {
    ...
    func updateBackgroundImages() {
        ...
        let normalImage = SwiftyButton.buttonImageWithColor(color: buttonColor, shadowHeight: shadowHeight, shadowColor: shadowColor, cornerRadius: cornerRadius)
        let highlightedImage = SwiftyButton.highlightedButtonImageWithColor(color: highlightedColor ?? buttonColor, shadowHeight: shadowHeight, shadowColor: shadowColor, cornerRadius: cornerRadius, buttonPressDepth: buttonPressDepth)
        let disabledImage = SwiftyButton.buttonImageWithColor(color: disabledButtonColor, shadowHeight: shadowHeight, shadowColor: disabledShadowColor, cornerRadius: cornerRadius)
